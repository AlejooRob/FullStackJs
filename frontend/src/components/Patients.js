            ...
            <div className="container mt-5 py-5">
                <div className="row">
                    <div className="col-12 mb-5 d-flex justify-content-center">
                        <Link to={'/nueva'} className="btn btn-primary text-uppercase py-2 px-5 font-weight-bold">Crear Cita</Link>
                    </div>
                            ...
                            {citas.map(cita => (
                                <Link to={`/cita/${cita._id}`} key={cita._id} className="p-5 list-group-item list-group-item-action flex-column align-items-start">
                                    ...
                                    <div className="contacto py-3">
                                        <p>Dueño: {cita.owner}</p>
                                        <p>Teléfono: {cita.telephone} </p>
                                    </div>
